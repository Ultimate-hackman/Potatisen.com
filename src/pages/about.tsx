  ...
  return (
    ...
    <>
      ...
      <Container>
        ...
        <p> Potatisen.com grundades i september 2020 av mig, David H, med målet att hjälpa samtliga elever på södermalmsskolan genom att skapa användbara funktioner som löser problem. Mer kommer komma. Ingen reklam sedan 2020.</p>
        {" "}
        Online sedan:
        {time[0]}
        {" "}
